...
class AstController < ApplicationController
  ...
  def gist
    ...
    yml = "v:1\nparser:2.6.3.0\nrails:5.2.3\nruby:2.5.5p157"
    Gist.multi_gist({"source.rb" => source, "transform.rb" => transform, "ruby-ast-explorer.yml" => yml}, :public => true , :description => "A Gist generated by ruby-ast-explorer")
    respond_to do |format|
      format.json { render :json => { message: "Exported to gist with name = <b>ruby-ast-explorer.yml</b> successfully." } } 
    end
  end
end
